...
#Yes, these data are tide because each variable has its own column, observation has it own row, and each values has its own cell. The data is in wide format
...
## # A tibble: 66 × 3
## # Groups:   site [11]
##    site         year  mean_enterococci_flu_average
##    <chr>        <chr>                        <dbl>
