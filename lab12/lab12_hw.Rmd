...
ui <- dashboardPage(
  ...
  radioButtons("x", "Choose The Year", choices = c("2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019"), 
              selected = "2010"),
  ...
  box(title = "University of California Admissions", width = 10,
...
server <- function(input, output, session) { 
  ...
  output$plot <- renderPlot({
    ...
    ggplot(aes(x=reorder(Ethnicity, FilteredCountFR), y=FilteredCountFR)) + 
      geom_col(color="gray", fill="blueviolet", alpha=0.5) +
...
server <- function(input, output, session) { 
  ...
  output$plot <- renderPlot({
    ...
    ggplot(aes(x=Academic_Yr, y=FilteredCountFR)) + 
      geom_col(color="green", fill="yellow", alpha=0.55) +
