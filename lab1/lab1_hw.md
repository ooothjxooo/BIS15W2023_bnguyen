...
RStudio is a GUI that help using R better and it lets you use lots of packages easily. You need R for Rstudio to work.GitHub is a file storage and management site used by programmers. It is useful because it allows programmers to upload code to repositories (folders) and make it publicly available.
