...
#NA is represented by -999 values
...
```
# Some animals don't lay eggs, so it makes sense that some animals have NA egg mass.
...
# I think the author use NA as a way to represent no and and 1 as a way to represent yes.

**10. Now that we know how NA's are represented in the `amniota` data, how would you load the data such that the values which represent NA's are automatically converted?**

```r
amniota1 <- readr::read_csv(file = "data/amniota.csv", na = c("-999"))
```
